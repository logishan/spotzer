                                            ...
                                            <div class="container">
                                                <div class="row align-items-center text-center">
                                                    ...
                                                    <div class="col-lg-6 col-md-6 text-end privacy">
                                                        <a href="javascript:void(0);" class="btn btn-link shadow-none border-0" >Privacy</a>
                                                        <a href="javascript:void(0);" class="btn btn-link shadow-none border-0">Terms</a>
                                                        <a href="javascript:void(0);" class="btn btn-link shadow-none border-0">About Us</a>
                                                    </div>
                                                </div>
                                        ...
                                        <div class="card-body">
                                            <div class="top-footer">
                                                <div class="row">
                                                    ...
                                                    <div class="col-lg-4 col-md-12">
                                                        <h6>Posts</h6>
                                                        <img alt="" src="{{asset('build/assets/images/media/48.jpg')}}" class="br-7">
                                                        <img alt="" src="{{asset('build/assets/images/media/49.jpg')}}" class="br-7">
                                                        <img alt="" src="{{asset('build/assets/images/media/50.jpg')}}" class="br-7">
                                                        <img alt="" src="{{asset('build/assets/images/media/51.jpg')}}" class="br-7">
                                                        <hr >
