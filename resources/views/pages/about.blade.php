...
@section('content')
						<div class="container">
							...
							<div class="row">
								<div class="col-lg-12">
									<img src="{{asset('build/assets/images/media/34.jpg')}}" alt="" class="br-5">
								</div>
							</div>
							<!-- ROW-2 CLOSED -->
										...
										<div class="card-body p-5 text-dark">
											<div class="statistics-info p-4">
												<div class="row align-items-center">
													...
													<div class="col-xl-6">
														<div class="text-center">
															<img src="{{asset('build/assets/images/media/22.jpg')}}" class="br-5" alt="">
														</div>
													</div>
												</div>
											</div>
												...
												<div class="row text-center">
														...
														<div class="card">
															<div class="card-body">
																<div class="counter-status">
																	<div class="counter-icon bg-primary-gradient mx-auto">
													...
													<div class="col-xl-3 col-md-6 col-lg-6">
														<div class="card">
															<div class="card-body">
																<div class="counter-status">
																	<div class="counter-icon bg-secondary-gradient mx-auto">
														...
														<div class="card">
															<div class="card-body">
																<div class="counter-statuss">
																	<div class="counter-icon bg-success-gradient mx-auto">
													...
													<div class="col-xl-3 col-md-6 col-lg-6">
														<div class="card">
															<div class="card-body">
																<div class="counter-status">
																	<div class="counter-icon bg-danger-gradient mx-auto">
							...
							<div class="row mt-5">
								...
								<div class="col-xl-3 col-md-6 col-lg-6 mt-3">
									<div class="card">
										<div class="card-body text-center">
											<img src="{{asset('build/assets/images/users/2.jpg')}}" alt="" class="avatar avatar-xxl bradius">
								...
								<div class="col-xl-3 col-md-6 col-lg-6 mt-3">
									<div class="card">
										<div class="card-body text-center">
											<img src="{{asset('build/assets/images/users/1.jpg')}}" alt="" class="avatar avatar-xxl bradius">
								...
								<div class="col-xl-3 col-md-6 col-lg-6 mt-3">
									<div class="card">
										<div class="card-body text-center">
											<img src="{{asset('build/assets/images/users/9.jpg')}}" alt="" class="avatar avatar-xxl bradius">
								...
								<div class="col-xl-3 col-md-6 col-lg-6 mt-3">
									<div class="card">
										<div class="card-body text-center">
											<img src="{{asset('build/assets/images/users/4.jpg')}}" alt="" class="avatar avatar-xxl bradius">
