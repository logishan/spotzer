                                            ...
                                            <div class="example">
                                                <ul class="list-group">
                                                    <li class="list-group-item">
                                                        Cras justo odio
                                                        <span class="badgetext badge badge-default rounded-pill">20</span>
                                                        </li>
                                                        <li class="list-group-item">
                                                        Dapibus ac facilisis in
                                                        <span class=" badgetext badge badge-default rounded-pill">15</span>
                                                        </li>
                                                        <li class="list-group-item">
                                                        Morbi leo risus
                                                        <span class=" badgetext badge badge-default rounded-pill">10</span>
                                                        </li>
                                                        <li class="list-group-item">
                                                        Porta ac consectetur ac
                                                        <span class=" badgetext badge badge-default rounded-pill">8</span>
                                                        </li>
                                                        <li class="list-group-item">
                                                        Vestibulum at eros
                            ...
                            <div class="row">
                                ...
                                <div class="col-sm-12 col-md-12">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="example list-group-disabled">
                                                <div class="list-group">
