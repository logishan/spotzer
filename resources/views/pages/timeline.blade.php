                                    ...
                                    <ul class="cbp_tmtimeline">
                                        ...
                                        <li>
                                            ...
                                            <div class="cbp_tmlabel">
                                                ...
                                                <div class="row">
                                                    <div class="col-lg-3 col-md-6 col-6"><a href="javascript:void(0);"><img src="{{asset('build/assets/images/media/16.jpg')}}" alt="" class="img-fluid img-thumbnail mt-4 mb-1"></a> </div>
                                                    <div class="col-lg-3 col-md-6 col-6"><a href="javascript:void(0);"> <img src="{{asset('build/assets/images/media/17.jpg')}}" alt="" class="img-fluid img-thumbnail mt-4 mb-1"></a> </div>
                                                    <div class="col-lg-3 col-md-6 col-6"><a href="javascript:void(0);"> <img src="{{asset('build/assets/images/media/18.jpg')}}" alt="" class="img-fluid img-thumbnail mt-4 mb-1"> </a> </div>
                                                    <div class="col-lg-3 col-md-6 col-6"><a href="javascript:void(0);"> <img src="{{asset('build/assets/images/media/19.jpg')}}" alt="" class="img-fluid img-thumbnail mt-4 mb-1"> </a> </div>
                                                </div>
                                            </div>
                                        </li>
                                        <li>
