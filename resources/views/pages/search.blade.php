                                        ...
                                        <div class="tab-content">
                                            <div class="tab-pane active" id="tab5">
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-2">
                                                            <a href="javascript:void(0);" class="h4 text-dark">Valex - Bootstrap HTML Dashboard Template</a>
                                                        </div>
                                                        <a href="javascript:void(0);" class="text-primary">https://www.spruko.com/demo/valex/html/</a>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-2">
                                                            <a href="javascript:void(0);" class="h4 text-dark">Spruha template related Images</a>
                                                        </div>
                                                        <div class="tags mb-2">
                                                            <span class="tag">
                                                        background
                                                        ...
                                                        <div class="mb-2">
                                                            <a href="javascript:void(0);" class="h4 text-dark">Spruha - Bootstrap HTML Dashboard Template</a>
                                                        </div>
                                                        <a href="javascript:void(0);" class="text-primary">https://www.spruko.com/demo/spruha/html/</a>
                                                        <p class="text-muted mt-2 mb-1">Treal Template included in 30 versions. In the demo 30 versions is shown in 4 floders. And In the final each version has single floder corresponding to that ...</p>
                                                        <p class="text-muted  mb-2">Tags: admin, admin dashboard, admin panel, admin template, backend, bootstrap, bootstrap 4, clean, dashboard, flat, jquery, modern, premium admin templates ...</p>
                                                        <div>
                                                            <a href="javascript:void(0);"><i class="fa fa-star text-yellow fs-16"></i></a>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-2">
                                                            <a href="javascript:void(0);" class="h4 text-dark">Zanex Website Templates from ThemeForest</a>
                                                        </div>
                                                        <a href="javascript:void(0);" class="text-primary">https://spruko.com/demo/zanex/html/</a>
                                                        <p class="text-muted mt-2 mb-2">Nemo enim ipsam voluptatem quia voluptas sit aspernatur aut odit aut fugit, sed quia consequuntur magni dolores eos qui ratione voluptatem sequi nesciunt. Neque porro quisquam est, qui dolorem ipsum quia
                                                            dolor sit amet, consectetur, adipisci velit, sed quia non numquam eius modi tempora incidunt ut labore et dolore magnam aliquam quaerat voluptatem.</p>
                                                        <div>
                                                            <a href="javascript:void(0);"><i class="fa fa-star text-yellow fs-16"></i></a>
                                                ...
                                                <div class="card">
                                                    <div class="card-body">
                                                        <div class="mb-2">
                                                            <a href="javascript:void(0);" class="h4 text-dark">Gowell - Travel HTML Template</a>
                                                        </div>
                                                        <a href="javascript:void(0);" class="text-primary">https://www.spruko.com/demo/gowell/html/</a>
                                                ...
                                                <div class="demo-gallery card">
                                                    <div class="card-body">
                                                        <ul id="lightgallery" class="list-unstyled row">
                                                            ...
                                                            <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0" data-responsive="{{asset('build/assets/images/media/5.jpg')}}" data-src="{{asset('build/assets/images/media/5.jpg')}}" data-sub-html="<h4>Gallery Image 5</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                                                <a href="javascript:void(0);">
                                                                    <img class="img-responsive br-5" src="{{asset('build/assets/images/media/5.jpg')}}" alt="Thumb-1">
                                                                </a>
                                                            </li>
                                                            <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0" data-responsive="{{asset('build/assets/images/media/6.jpg')}}" data-src="{{asset('build/assets/images/media/6.jpg')}}" data-sub-html="<h4>Gallery Image 6</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                                                <a href="javascript:void(0);">
                                                                    <img class="img-responsive br-5" src="{{asset('build/assets/images/media/6.jpg')}}" alt="Thumb-2">
                                                                </a>
                                                            </li>
                                                            <li class="col-xs-6 col-sm-4 col-md-4 col-xl-4 mb-5 border-bottom-0" data-responsive="{{asset('build/assets/images/media/7.jpg')}}" data-src="{{asset('build/assets/images/media/7.jpg')}}" data-sub-html="<h4>Gallery Image 7</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                                                <a href="javascript:void(0);">
                                                            ...
                                                            <li class="col-xs-6 col-sm-4 col-md-4 col-xl-3 mb-5 border-bottom-0" data-responsive="{{asset('build/assets/images/media/9.jpg')}}" data-src="{{asset('build/assets/images/media/9.jpg')}}" data-sub-html="<h4>Gallery Image 9</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                                                <a href="javascript:void(0);">
                                                                    <img class="img-responsive mb-0 br-5" src="{{asset('build/assets/images/media/9.jpg')}}" alt="Thumb-1">
                                                                </a>
                                                            </li>
                                                            <li class="col-xs-6 col-sm-4 col-md-4 col-xl-3 mb-xl-0 mb-md-0 mb-md-0 mb-5 border-bottom-0" data-responsive="{{asset('build/assets/images/media/10.jpg')}}" data-src="{{asset('build/assets/images/media/10.jpg')}}" data-sub-html="<h4>Gallery Image 10</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                                                <a href="javascript:void(0);">
                                                                    <img class="img-responsive mb-0 br-5" src="{{asset('build/assets/images/media/10.jpg')}}" alt="Thumb-2">
                                                                </a>
                                                            </li>
                                                            <li class="col-xs-6 col-sm-4 col-md-4 col-xl-3 mb-5 mb-md-0 mb-xl-0  border-bottom-0" data-responsive="{{asset('build/assets/images/media/11.jpg')}}" data-src="{{asset('build/assets/images/media/11.jpg')}}" data-sub-html="<h4>Gallery Image 11</h4><p> Many desktop publishing packages and web page editors now use Lorem Ipsum</p>">
                                                                <a href="javascript:void(0);">
                                                                    <img class="img-responsive mb-0 br-5" src="{{asset('build/assets/images/media/11.jpg')}}" alt="Thumb-1">
                                                                </a>
                                                            </li>
                                                        </ul>
                                                    </div>
