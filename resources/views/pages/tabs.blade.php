                            ...
                            <div class="row">
                                <div class="col-xl-6">
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="panel panel-primary default-panel-primary">
                                    ...
                                    <div class="card">
                                        ...
                                        <div class="card-body">
                                            <div class="tab_wrapper second_tab">
                                                <ul class="tab_list">
                                                    <li class="active br-0">Tab 1</li>
                                                    <li class="br-0">Tab 2</li>
                                                    <li class="br-0">Tab 3</li>
                                                    <li class="br-0">Tab 4</li>
                                                    <li class="br-0">Tab 5</li>
                                                    <li class="br-0">Tab 6</li>
                                                </ul>

                                                <div class="content_wrapper br-5 mt-1 br-tr-0 br-br-0">
...
@section('scripts')
		...
		<script src="{{asset('build/assets/plugins/tabs/tab-content.js')}}"></script>
